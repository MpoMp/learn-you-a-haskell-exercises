...
sumSquares a b = foldl1 (+) $ map sq [a .. b]
...
higherOrderSum intApplication a b = foldl1 (+) $ map intApplication [a .. b]
...
higherOrderSequenceApplication a b op f z = if a > b 
                                            then z 
                                            else foldl1 f $ map op [a .. b]


-- Define a factorial method using the higherOrderSequenceAppliction
hoFactorial :: Int -> Int -- needs another type, overflows pretty soon
hoFactorial a = higherOrderSequenceApplication 1 a (1*) (*) 1
